  ...
  return (
    <div className="space-y-8 pb-20 md:pb-8">
      ...
      <div>
        ...
        <p className="text-xs text-gray-600 font-medium">Track real-world emissions avoided & AI weekly progress summary.</p>
      </div>

      {/* Hero Before vs After Metric Comparison */}
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <GlassCard className="text-center p-6 border-red-200 bg-red-50/50">
          <div className="text-xs font-mono text-rose-700 font-bold uppercase">Initial Baseline Footprint</div>
          <div className="mt-2 font-mono text-3xl font-black text-rose-900">{beforeFootprint} kg</div>
          <div className="mt-1 text-xs text-gray-500 font-medium">CO₂e / month</div>
        </GlassCard>

        <GlassCard className="text-center p-6 border-emerald-200 bg-emerald-50/50">
          <div className="text-xs font-mono text-emerald-800 font-bold uppercase">Current Estimated Footprint</div>
          <div className="mt-2 font-mono text-3xl font-black text-emerald-700">{currentFootprint} kg</div>
          <div className="mt-1 text-xs text-gray-500 font-medium">CO₂e / month</div>
        </GlassCard>

        <GlassCard glow className="text-center p-6 border-amber-300 bg-amber-50/50">
          <div className="text-xs font-mono text-amber-800 font-bold uppercase">Total Emissions Prevented</div>
          <div className="mt-2 font-mono text-3xl font-black text-amber-700">-{totalAvoided} kg</div>
          <div className="mt-1 text-xs text-gray-500 font-medium">Verified Eco Reduction</div>
        </GlassCard>
      </div>
      ...
      <GlassCard glow className="border-l-4 border-l-purple-600">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="rounded-full border border-purple-200 bg-purple-50 px-3 py-1 font-mono text-xs font-bold text-purple-800">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 text-xs">
            <span className="font-mono font-bold text-emerald-800 uppercase">Top Weekly Achievement</span>
            <p className="mt-1 text-gray-600 font-medium">{weeklyReport.topAchievement}</p>
          </div>

          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 text-xs">
            <span className="font-mono font-bold text-amber-800 uppercase">AI Recommended Next Focus</span>
            <p className="mt-1 text-gray-600 font-medium">{weeklyReport.nextFocusArea}</p>
          </div>
        </div>
      </GlassCard>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-medium">{cat.amountKg} kg CO₂e / month ({cat.percentage}%)</p>
                  </div>
                </div>
                <span
